...
show_help() {
    ...
    echo "  sudo dnstm-setup --domain example.com Use a domain non-interactively for setup"
    ...
    echo "  --domain <domain>  Use a domain without prompting in the main setup flow"
